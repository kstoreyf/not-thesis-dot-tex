This chapter appears in \emph{the Astrophysical Journal} with title ``Two-point statistics without bins: A continuous-function generalization of the correlation function estimator for large-scale structure'' and full author list Kate Storey-Fisher (NYU) and David W. Hogg (NYU / Flatiron / MPIA) \citep{storey-fisher_two-point_2021}.
