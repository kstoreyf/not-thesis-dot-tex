...
For these quantifications we also include only areas that have $A_v < \val{Avhi}$, which is \val{area_gcathi} of the sky, as well as at least one quasar in a healpixel.
