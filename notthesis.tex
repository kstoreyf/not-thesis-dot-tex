...
\RequirePackage[raggedright,rm]{titlesec}
\titleformat{\section}
  {\LARGE}{\thesection}{1em}{}
...
{\Huge}
{\textcolor{black}{\thechapter}\hsp\textcolor{gray75}{|}\hsp}
{0pt}{\setstretch{1.25}\Huge\raggedright}
...
\begin{center}
  {\Large
    \begin{doublespace}
      {\textcolor{black}{\huge\textsc{\thesistitle}}}
    \end{doublespace}
  }
  \vspace{.7in}
...
\cftsetindents{figure}{0em}{3.4em}
\cftsetindents{table}{0em}{3.4em}
%\renewcommand{\@tocrmarg}{-8em} 
...
% Start chapters at 0 (Introduction is chapter 0)
...
\renewcommand{\bibpreamble}{
  \epigraph{\emph{Q: What does it mean if I get a small snake that is also very strong?\\
  A: Snake-picking is not an exact science. \ldots Although if you get a poisonous snake, it often means that there was a problem with the formatting of your bibliography.}}{\vspace{1em}{\emdash}Luke Barrage\\``FAQ: The `Snake Fight' Portion of Your Thesis Defense''}
}

\bibliography{references,references_quaia}
