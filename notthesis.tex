...
% It encodes information about the physics of the early Universe and the subsequent expansion history \cite{SunyaevZeldovich1970, HuSugiyama1996, Riess1998}.
...
I'd like to cite \cite{secrest_test_2021}! 
also \cite{wright_wide-field_2010}
how about \cite{tinker_void_2007}
cool what if add \cite{storey-fisher_aemulus_2022}
hello to \cite{storey-fisher_anomaly_2021}
also \citep{SunyaevZeldovich1970}!
